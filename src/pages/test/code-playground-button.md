...
```js-data-line="3"-data-playground-session-id="test-playground-rectangle-change"-data-playground-mode="playground"-data-playground-session="new"-data-playground-execution-mode="script"-data-express-url="https://stage.projectx.corp.adobe.com/new"
...
const [red, green, blue, alpha] = [0.4, 0.6, 0.2, 0.7];
