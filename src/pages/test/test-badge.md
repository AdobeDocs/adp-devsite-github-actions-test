...
description: Learn how to obtain the necessary access, credentials, and configure your local development environment and tools for building Adobe App Builder applications.
keywords:
- App Builder
- Access
- Credentials
