...
description: Overview of roles, permissions, and access control in Adobe Cloud Storage and Collaboration, including how to assign, update, and remove roles using the API.
keywords:
