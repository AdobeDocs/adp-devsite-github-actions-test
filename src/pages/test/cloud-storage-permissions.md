...
description: Overview of roles, permissions, and access control in Adobe Cloud Storage, including how to assign roles and manage permissions using the Collaboration API.
keywords:
  - Adobe Cloud Storage
  - collaboration API
  - roles
