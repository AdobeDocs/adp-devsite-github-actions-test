...
description: Overview of roles, permissions, and access control in Adobe Cloud Storage, including API usage for assigning, updating, and removing user and group roles.
keywords:
  - Adobe Cloud Storage
