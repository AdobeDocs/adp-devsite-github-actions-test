...
[from express/add-ons/docs](https://stage--adp-devsite-stage--adobedocs.aem.page/express/add-ons/docs/guides/support/faq)
...
DEVSITE-1987 ERROR 26

```bash
npm run start -- --port 8080
```

DEVSITE-1987 ERROR 27

### Is `yarn` supported with the CLI, or only `npm`?

DEVSITE-1987 ERROR 28
