...
- Name: content.spec.js >> content: /events/docs/guides/using/asset-events/asset-events-actions
- Location: test/content.spec.js:92:3

# Error details

```
Error: Content issues on stage for /events/docs/guides/using/asset-events/asset-events-actions
...
- Array []
+ Array [
+   "BLOCKS: 10 empty block(s) — horizontalline background-color-white",
+ ]
```
