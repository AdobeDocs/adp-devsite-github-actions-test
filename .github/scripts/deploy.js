...
// /**
//  * Generates URLs dev-site changes
//  *
//  * @param github
//  * @param context
//  * @param glob
...
//  */
// export default async function deployChanges({ github, context, glob, changes, }) {
module.exports = async ({ core, changes, isStage, isProd }) => {
  ...
  // const aemEndPoint = `https://admin.hlx.page/${OPERATION}/adobedocs/${site}/${code_repo_branch}/${path}`
